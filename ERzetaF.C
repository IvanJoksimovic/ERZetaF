...
tmp<volScalarField> ERzetaF<BasicTurbulenceModel>::Tau() const
{
    return 1.0/omega_;
}

template<class BasicTurbulenceModel>
tmp<volScalarField> ERzetaF<BasicTurbulenceModel>::L() const
{
	return CL_*pow(k_,0.5)/omega_;
}

template<class BasicTurbulenceModel>
void ERzetaF<BasicTurbulenceModel>::correctNut()
{
...
:
  ...
  template<class BasicTurbulenceModel>
  bool ERzetaF<BasicTurbulenceModel>::read()
  {
  ...
  template<class BasicTurbulenceModel>
  void ERzetaF<BasicTurbulenceModel>::correct()
  {
    if (!this->turbulence_)
    {
        return;
